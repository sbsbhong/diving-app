...
- WatchConnectivity code boundary와 companion embed project 구조는 추가됐지만, pairing, entitlement setup, background delivery, retry behavior, paired iPhone 실기기 전송은 아직 검증되지 않았다.
